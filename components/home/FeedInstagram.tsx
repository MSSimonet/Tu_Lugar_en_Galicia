    ...
    >
      <div className="mx-auto max-w-4xl">
        <h2
          ...
          className="mb-[var(--space-2)] text-center font-[family-name:var(--font-ui)] [font-size:var(--text-xs)] tracking-[var(--tracking-ui)] uppercase"
          ...
          {cuadros.map((n) => (
            ...
            >
              ...
              <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                className="absolute inset-0 m-auto h-8 w-8 [color:var(--color-niebla)]"
                aria-hidden="true"
              >
        ...
        <p className="mt-[var(--space-8)] text-center font-[family-name:var(--font-ui)] [font-size:var(--text-xs)] [color:var(--color-pizarra)]">
