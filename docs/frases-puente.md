# Frases puente del Plan Estratégico
...
> Tuteo neutro, sin "vos" ni "vosotros".

---

## Fase 0 — En el país de origen
...
## Fase 1 — Llegada y residencia legal
...
## Fase 3 — Empadronamiento y fiscalidad
...
29. Si todavía no estás empadronado pero necesitas atención médica, no quedas desamparado:
30. Y si tu situación es particular y aún no cotizas, también hay una vía para no quedar sin sanidad:
...
36. Y si deseas dejar registradas tus voluntades médicas, también puedes hacerlo:

## Fase 6 — Familia, estudios y conducción
...
40. Tu título universitario merece valer aquí también; como tu profesión está regulada, necesita homologación:
41. Y como tu profesión no está regulada, te basta con la declaración de equivalencia, más ágil:
...
## Fase 7 — Ciudadanía española (pasaporte español sin DNI)
