# Textos — Cómo funciona (`/como-funciona`)
...
**Tiempo estimado:** 1-3 semanas (según disponibilidad del mercado)

Acá empieza el trabajo de campo. Silvana y su red de contactos en Galicia salen a buscar activamente: revisan portales, contactan propietarios directamente, consultan redes informales de alquiler que no aparecen en internet. Filtran por tus criterios concretos — ciudad, barrio, presupuesto, habitaciones, mascotas, fecha de entrada — y descartan las opciones que no cumplen sin gastar tu tiempo.

Este paso puede durar desde unos días hasta algunas semanas según la ciudad y el momento del mercado. Te mantenemos informado durante todo el proceso.
...
### Paso 5 — Negociación y cierre del contrato
