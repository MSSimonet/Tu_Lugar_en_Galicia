    ...
    <div className="min-h-screen bg-[var(--color-blanco)]">
      ...
      <div className="bg-[var(--color-niebla)] border-b border-[var(--color-arena)]">
        <div className="max-w-2xl mx-auto px-[var(--space-6)] pb-[var(--space-16)]" style={{ paddingTop: 'calc(64px + 60px)' }}>
          ...
          <p className="font-[family-name:var(--font-ui)] [font-size:var(--text-sm)] md:[font-size:var(--text-md)] [color:var(--color-pizarra)] leading-[var(--leading-cuerpo)] mb-[var(--space-4)]">
          ...
          <p className="font-[family-name:var(--font-ui)] [font-size:var(--text-xs)] [color:var(--color-pizarra)] opacity-80">
