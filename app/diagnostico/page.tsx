...
import { FormularioDiagnostico } from '@/components/diagnostico'

export const metadata: Metadata = getNextMetadata('diagnostico')
      ...
      <div className="bg-[var(--color-niebla)] border-b border-[var(--color-arena)]">
        <div className="max-w-2xl mx-auto px-[var(--space-6)] py-[var(--space-16)]">
          ...
          <p className="font-[family-name:var(--font-ui)] text-[var(--text-sm)] md:text-[var(--text-md)] text-[var(--color-pizarra)] leading-[var(--leading-cuerpo)] mb-[var(--space-4)]">
            Este diagnóstico nos ayuda a entender tu situación para que Silvana pueda evaluar si puede ayudarlos y cómo. No es un formulario de contacto genérico: cada campo importa para armar tu caso.
          </p>
