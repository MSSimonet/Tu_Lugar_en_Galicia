...
const data = [
  ...
  },
  {
    ...
    src: '/images/ciudades/tag_vigo.jpg',
  },
]
  ...
  useEffect(() => {
    ...
    function tick(now: number) {
      if (pausedRef.current) {
        // Anchor cycleStart while paused so resume picks up at the same frac
    ...
    >
      ...
      <div style={{ position: 'relative', maxWidth: '1500px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          paddingBottom: '44px', borderBottom: '1px solid rgba(31,45,39,0.11)',
        }}>
          {/* Izquierda */}
          <div>
            ...
            <h2 style={{
              ...
              fontSize: '76px', lineHeight: '0.95', margin: 0,
              color: '#1B2A24', letterSpacing: '-0.018em',
            }}>
              Cinco pasos<br />
              <em style={{ fontStyle: 'italic', fontWeight: 500 }}>hasta tu hogar</em><br />
              en Galicia
            </h2>
          </div>

          {/* Derecha */}
          <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', gap: '32px', paddingBottom: '4px' }}>
            <p style={{
        ...
        {/* ── Split: stage + stepper ─────────────────────────────────────── */}
        <div style={{ display: 'grid', gridTemplateColumns: '1.55fr 1fr', gap: '56px', alignItems: 'stretch' }}>

          {/* STAGE */}
          <div style={{
            position: 'relative', borderRadius: '18px', overflow: 'hidden',
            minHeight: '624px', background: '#E6DFCD',
